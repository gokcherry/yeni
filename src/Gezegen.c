...
* @since Mayıs 2025
* <p>
* Gezegen yapısı ve fonksiyonları. Burada gezegenin türü, ismi, gün/saat uzunluğu ve tarihi gibi bilgiler tutulur.
* Gezegenin türü, gezegenin yaşlanma katsayısını belirler. Bu katsayı, gezegenin yaşlanma hızını etkiler. 
* </p>
*/
#include <stdlib.h>
#include <string.h>
